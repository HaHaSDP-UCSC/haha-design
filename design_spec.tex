...
\begin{abstract}
  Current senior emergency button systems on the market are serve a very specific user base, immediately escalating any request for assistance to emergency services (police, fire, EMS) and requiring a reoccurring cost to maintain connectivity to staffed call centers to handle these requests. There is a need for a cheap, single upfront cost device that simply calls your friends/neighbors to help you in times of non-critical emergencies. This project aimed to build such a system, composed of a series of button wearables and base stations, to be deployed and tested in the De Anza Santa Cruz retirement community.
\end{abstract}
